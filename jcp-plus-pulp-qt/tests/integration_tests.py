...
#   from the jcp-plus-pulp-server/jcp-plus-pulp-client integration test. We might want
...
if __name__ == "__main__":
    with running_process(["jcp-plus-pulp-qt", "--testing", "--autostart-modules=none"]) as proc:
