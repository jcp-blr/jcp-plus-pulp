...
def get_config_dir(module_name: Optional[str] = None) -> str:
    config_dir = platformdirs.user_config_dir("jcp-plus-pulp")
...
def get_log_dir(module_name: Optional[str] = None) -> str:  # pragma: no cover
    ...
    # https://github.com/jcp-blr/jcp-plus-pulp-core/pull/122#issuecomment-1768020335
    if sys.platform.startswith("linux"):
        log_dir = platformdirs.user_cache_path("jcp-plus-pulp") / "log"
    else:
        log_dir = platformdirs.user_log_dir("jcp-plus-pulp")
