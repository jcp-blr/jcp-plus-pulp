...
keychain_profile="jcp-plus-pulp-$APPLE_PERSONALID"  # name of the keychain profile to use
bundleid=net.jcppluspulp.JCPPLUSPULP # Match jcp-plus-pulp.spec
app=dist/JCP+ PULP.app
dmg=dist/JCP+ PULP.dmg
