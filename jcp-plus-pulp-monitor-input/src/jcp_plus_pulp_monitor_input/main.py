...
from jcp_plus_pulp_monitor_away.listeners import KeyboardListener, MouseListener
...
def main(testing: bool):
    ...
    logger.info("Starting jcp_plus_pulp_monitor_input...")
    client = jcp_plus_pulp_client.PULPMonitorClient("jcp-plus-pulp-monitor-input", testing=testing)
    client.connect()
