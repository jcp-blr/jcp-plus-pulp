...
[jcp-plus-pulp-capture-afk-testing]
timeout = 20
poll_time = 1
""".strip()
...
def load_config(testing: bool):
    section = "jcp-plus-pulp-capture-afk" + ("-testing" if testing else "")
    return load_config_toml("jcp-plus-pulp-capture-afk", default_config)[section]
