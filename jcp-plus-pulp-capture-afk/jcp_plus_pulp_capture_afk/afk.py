...
class AFKWatcher:
    def __init__(self, args, testing=False):
        ...
        self.client = ActivityWatchClient(
            "jcp-plus-pulp-capture-afk", host=args.host, port=args.port, testing=testing
        )
    ...
    def run(self):
        logger.info("jcp-plus-pulp-capture-afk started")
    ...
    def heartbeat_loop(self):
        ...
        while True:
            try:
                ...
                logger.info("jcp-plus-pulp-capture-afk stopped by keyboard interrupt")
                break
