...
def load_config():
    return load_config_toml("jcp-plus-pulp-monitor-window", default_config)["jcp-plus-pulp-monitor-window"]
...
def parse_args():
    ...
    parser = argparse.ArgumentParser(
        description="A cross platform window watcher for JCP+ PULP.\nSupported on: Linux (X11), macOS and Windows."
    )
