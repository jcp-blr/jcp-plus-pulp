...
from jcp_plus_pulp_datastore import get_storage_methods
...
def main():
    ...
    # at the path specified by jcp_plus_pulp_core.log.get_log_file_path(). We probably want
...
def parse_settings():
    ...
    """ CLI Arguments """
    parser = argparse.ArgumentParser(description="Starts an JCP+ PULP server")
    parser.add_argument(
        "--testing",
        action="store_true",
        help="Run jcp-plus-pulp-server in testing mode using different ports and database",
    )
