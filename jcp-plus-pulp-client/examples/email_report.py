...
def main(read_stdin=True) -> None:
    ...
    sender = Recipient("Maruthi Gowda (automated script)", "ygowda@jcp.com")
    ...
    if read_stdin:
        ...
        text = "Just a test. JCP+ PULP stats will go here."
    ...
    subject = "Example report from jcp-plus-pulp-client"
