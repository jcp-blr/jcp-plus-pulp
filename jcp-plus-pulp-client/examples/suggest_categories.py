...
from jcp_plus_pulp_client import queries


# set up client
awc = jcp_plus_pulp_client.PULPMonitorClient("test")


def example_categories():
    # TODO: Use tools in jcp-plus-pulp-research to load categories from toml file
    return [
        (
            ("Work", "JCP+ PULP"),
            {"type": "regex", "regex": "jcp-plus-pulp-|jcp_plus_pulp", "ignore_case": True},
        ),
    ]
