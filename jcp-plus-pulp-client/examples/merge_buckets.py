...
from jcp_plus_pulp_transform.filter_period_intersect import _intersecting_eventpairs
...
def main():
    ...
    Useful to fix duplicate buckets caused by a changing hostname, as in this issue:
      https://github.com/jcp-blr/jcp-plus-pulp/issues/454
    """

    # You need to set testing=False if you're going to run this on your normal instance
    aw = jcp_plus_pulp_client.PULPMonitorClient(testing=True)
